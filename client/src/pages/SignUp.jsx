...
const btnGoogle = "w-full bg-[#1a4a8f] text-white border-0 hover:bg-[#2d6cb5]";
  ...
  return (
    <div className={pageLayout}>
      <header className="w-full py-5 px-10 text-left">
        <Link to="/" className="text-[1.25rem] !text-white !font-semibold no-underline hover:underline">
          StudyScheduler
        </Link>
      </header>

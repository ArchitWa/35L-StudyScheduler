...
const HomepageLoggedOut = () => {
  return (
    <div className="font-sans min-h-screen flex flex-col">
      {/* Header Section (Blue) */}
      <header className="bg-linear-to-br from-[#1a4a8f] to-[#2d6cb5] text-white pb-15">
        ...
        <div className="text-center py-10 px-5">
          ...
          <div className="text-[1.1rem] leading-[1.6] text-white/90 max-w-175 mx-auto mb-7.5">
      ...
      <main className="bg-[#f4f6f8] grow p-10 flex flex-col items-center">
        <h2 className="text-2xl font-bold text-[#333] mb-7.5 text-center">Why StudyScheduler?</h2>
        <div className="flex justify-center gap-5 w-full max-w-300 mb-12.5 flex-nowrap overflow-x-auto">
          <div className="w-100 h-55 border-[3px] border-dashed border-[#b0c4de] bg-[#eaf0f6] flex justify-center items-center text-[#5a7a9e] font-semibold rounded-lg text-center p-6 text-lg">Don't study alone. Connect with classmates in your specific courses and sections to form high-impact study groups that actually get work done.</div>
